    ...
    return function typeCrop(titles, sourceFilePath) {
        ...
        var httpRequest = function (method, url) {
         ...
         var svgAttributes = {
            ...
            s: {
                viewBox: '0 0 195 417',
                path: 'M94.5,153.4c19.1,0,29.2,9.4,33.8,21.6h53.2l2.5-4.6c-7.8-35.9-38-63.1-89.8-63.1c-49,0-85,28.4-85,71.6\
        ...
        var createSVG = function() {
            ...
            var createGroups = function() {
                ...
                return Object.keys(svgAttributes).map(function(val, i) {
